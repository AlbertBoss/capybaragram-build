...
Android с новой палитрой собран и прошёл стартовую проверку; ниже уже показаны его реальные экраны. Обновлённая Windows-версия ещё собирается. Дополнительная правка индикатора страниц Android собрана: в новой проверке запуск и переключение тем прошли, но общий результат проверки отрицательный — тест не смог открыть список приложений системного лаунчера. [Как устроено оформление и что перенесено из концепта](docs/APPEARANCE.md).
...
Галерея внутренних экранов пока готовится: список чатов, переписка, заметки и шаблоны в обеих темах. Для неё будут использоваться только специально созданные демонстрационные данные. Проверка новой тёмной формы входа Windows ещё не завершена.
