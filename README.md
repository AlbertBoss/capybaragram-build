...
Внутренние экраны с новым оформлением будут опубликованы после проверки соответствующих сборок. Снимки прежнего Windows-интерфейса с видимым курсором убраны из галереи. Полная переработка расположения элементов по выбранному концепту ещё не закончена.
