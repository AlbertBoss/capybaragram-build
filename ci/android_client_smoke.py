...
APK_SHA = '7d8f35eec060010243c0b51f116dcde24a4d32025a90ab7fba786054af64539b'
...
def snapshot(name):
    ...
    for attempt in range(12):
        ...
        try:
            ...
            # Continuous accessibility updates can prevent the stock dumper from
            # reaching idle. Wait boundedly without accepting an older hierarchy.
...
result = {'apk_sha256':APK_SHA,'certificate_sha256':CERT_SHA,'artifact_run':34014095518,
